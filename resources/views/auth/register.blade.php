...
<div class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white rounded-2xl shadow p-8">
        ...
        <p class="text-slate-500 mb-6">შექმენი ანგარიში და მიიღე API გასაღები</p>
        ...
        <form method="POST" action="/register" class="space-y-4">
            ...
            <div>
                <label class="block text-sm font-medium mb-1">გაიმეორე პაროლი</label>
        ...
        <p class="text-center text-sm text-slate-500 mt-6">
            უკვე გაქვს ანგარიში? <a href="/login" class="text-indigo-600 font-medium">შესვლა</a>
        </p>
    </div>
</div>
@endsection
